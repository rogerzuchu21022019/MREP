...
import nam.zuchu.asm.adapters.viewpager.IntroViewPagerAdapter
import nam.zuchu.asm.databinding.FragmentContainerFmBinding
...
class ContainerFM : Fragment(){
    ...
    fun initViewPager2(view : View){
        ...
        containerFmBinding.ci3.setViewPager(containerFmBinding.viewpager)
                    ...
                    2 -> {
                        ...
                        if(containerFmBinding.viewpager.currentItem == FRAGMENT_INTRO3){
                            ...
                            a.setOnClickListener{
                                ...
                                var action = ContainerFMDirections.actionContainerFMToLoginFM()
